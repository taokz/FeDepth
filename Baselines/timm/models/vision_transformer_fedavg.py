...
class VisionTransformer(ScalableModule):
    """ Vision Transformer
    ...
    def __init__(
        ...
        """
        super(VisionTransformer, self).__init__(width_scale=width_scale, rescale_init=rescale_init, rescale_layer=rescale_layer)
        self.width_scale = width_scale
        if self.width_scale != 1.:
            embed_dim = embed_dim * self.width_scale
...
@register_model
def vit_tiny_patch16_224_fedavg(pretrained=False, **kwargs):
    """ ViT-Tiny (Vit-Ti/16)
    """
